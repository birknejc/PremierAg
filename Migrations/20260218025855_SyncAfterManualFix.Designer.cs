...
namespace PAS.Migrations
{
    ...
    [Migration("20260218025855_SyncAfterManualFix")]
    partial class SyncAfterManualFix
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PAS.Models.LoadMix2", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("LoadMix2GroupId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PAS.Models.LoadMix2Detail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("LoadMix2Id");

                    b.HasIndex("ProductId");

                    b.ToTable("LoadMix2Details");
                });

            modelBuilder.Entity("PAS.Models.LoadMix2Field", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PAS.Models.QuoteInventory", b =>
                {
                    ...
                    b.Property<decimal>("ProductWeightedAveragePrice")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("PAS.Models.LoadMix2Detail", b =>
                {
                    b.HasOne("PAS.Models.LoadMix2", "LoadMix2")
                        .WithMany("LoadMixDetails")
                        .HasForeignKey("LoadMix2Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
